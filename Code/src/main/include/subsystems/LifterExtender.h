...
private:
   ...
   rev::SparkMaxRelativeEncoder ExtendEncdr = ExtendMotor.GetEncoder(rev::CANEncoder::EncoderType::kHallSensor, 42);
   rev::SparkMaxRelativeEncoder LiftEncdr = LifterMotor.GetEncoder(rev::CANEncoder::EncoderType::kHallSensor, 42);
